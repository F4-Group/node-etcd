...
var CancellationToken, Client, defaultClientOptions, defaultRequestOptions, exports, request, requestsync, _,
...
Client = (function() {
  ...
  Client.prototype.execute = function(method, options, callback) {
    var helperRequest, opt, servers, token;
    ...
    helperRequest = this._multiserverHelper(servers, opt, token, callback);
  ...
  Client.prototype._multiserverHelper = function(servers, options, token, callback) {
    ...
    syncRespHandler = function(err, body, headers) {
      var msg;
      return msg = {
        err: err,
        body: body,
    ...
    if (options.synchronous === true) {
      ...
      return reqRespHandler(req.err, req.resp, req.body);
    } else {
